---
layout: post
title: '[NLP] CS224N - [1] Word Vectors: (2) GloVe'
date: 2024-11-27 03:40:00
categories: [NLP, CS224N]
tags: [Word Vectors, Word Senses, co-occurence, SVD, GloVe]
math: true
toc: true
render_with_liquid: true
img_path: /assets/img/for_post/
image:
  path: assets/img/for_post/241127-t.jpg
description: CS224N 2강을 정리한 글로, Word Senses, Co-occurrence Matrix, GloVe에 대해 설명한다.
---

## CS224N Series

- [ ] [[1] Word Vectors](https://minsuk1003.github.io/posts/CS224N-1/)
- [x] <span style="color: #07a8f7">[2] **Word Senses**</span>
...
> 이번 포스팅에서는 CS224N 2강에서 다룬 Word Senses, Co-occurrence Matrix, SVD, 그리고 GloVe에 대해 설명한다.
{: .prompt-info}

---
## Word Senses

**Word Senses**는 단어의 여러 의미를 의미하며, 단어는 문맥에 따라 다양한 의미를 가질 수 있다.

예룰 들어, `pike`라는 단어는 다음의 의미를 모두 가질 수 있다.
- 물고기: "pike swims in the lake."
- 막대기: "a pike was used as a weapon."
- 도로: "driving on the pike."

> 따라서, Word2Vec과 같이 단일 벡터를 통해 한 단어의 모든 의미를 표현하는 방법은 여러 문맥을 고려할 수 없다.
{: .prompt-warning}
...
**네거티브 샘플링 <sup>Negative Sampling</sup>** 은 소프트맥스 계산 문제를 해결하기 위해 고안된 방법으로, 

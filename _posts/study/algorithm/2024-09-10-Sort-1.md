...
categories:
  ...
  - algorithm
description: >
  Selection Sort (선택 정렬), Bubble Sort (버블 정렬), Insertion Sort (삽입 정렬), Stable, In-place

---
정렬 알고리즘은 컴퓨터 과학에서 매우 중요한 역할을 수행하며, 알고리즘의 꽃으로 불린다. 이 글에서는 정렬 알고리즘의 기본적인 개념과 3가지의 기본 정렬 알고리즘, 선택, 버블, 삽입 정렬에 대해 알아보자.

## 목차
- [Sort](#sort)
  - [1. Selection Sort (선택 정렬)](#1-selection-sort-선택-정렬)
  - [2. Bubble Sort (버블 정렬)](#2-bubble-sort-버블-정렬)
...
![image](https://github.com/user-attachments/assets/84ad7386-adff-4b77-87c4-70d795ce4b7f)
...
![selection](https://github.com/user-attachments/assets/966d753d-7bbf-4617-b60b-301a3c6ad74c)
...
![image](https://github.com/user-attachments/assets/a42db5af-f217-4b09-8ba5-5165e097b0b8)
...
![insertion-sort](https://github.com/user-attachments/assets/ca254ec8-0dd0-4d9b-a14e-f777eab196a1)

삽입 정렬은 버블 정렬과 동일하게 이미 정렬된 최선의 경우, 시간 복잡도가 $O(n)$까지 감소되지만, 보통, 최악의 경우 시간 복잡도는 $O(n^2)$로 비효율적인 알고리즘이다.
...
1. [Stable Sorting Algorithms](#https://product.kyobobook.co.kr/detail/S000001916959)

2. [Sorting Algorithm Explained](http://www.xybernetics.com/techtalk/SortingAlgorithmsExplained/SortingAlgorithmsExplained.html)

3. [신찬수 교수 유튜브](https://youtu.be/Du-EHAUE0kM?si=-d_ud1gNag7QLY20)
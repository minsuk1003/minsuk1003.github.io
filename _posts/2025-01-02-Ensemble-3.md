...
---
지난 2편에서는 개별 학습기 간 의존성이 약하며, 병렬화 방식인 배깅 <sup>Bagging</sup> 방식을 다루었다.

> 이번 3편에서는 개별 학습기 간 의존성이 강하며, 연속화 방식인 Boosting 방식과, 대표적인 AdaBoost와 Gradient Boost, 두 방법론을 설명한다.
{: .prompt-info}
